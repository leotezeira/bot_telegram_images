“””
Módulo de prompts para generación de imágenes de modelos con remeras.
Mantiene consistencia en: modelo, prenda, iluminación y fondo.
“””
...
# ── Opciones de iluminación específica ────────────────────────────────────────
...
“””
Parsea el caption del usuario y extrae parámetros de customización.
...
Mantiene fidelidad al diseño de la remera del mockup + estilo foto Instagram/web.
...
“”“Retorna el prompt negativo estándar.”””
